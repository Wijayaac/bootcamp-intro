<?php
$anggrekStreetLength = isset($_GET['anggrek_street']) ? $_GET['anggrek_street'] * 1000 : null; //km to m
$kambojaStreetLength = isset($_GET['kamboja_street']) ? $_GET['kamboja_street'] : null; // m
$lotusStreetLength = isset($_GET['lotus_street']) ? $_GET['lotus_street'] / 100 : null; // cm to m
